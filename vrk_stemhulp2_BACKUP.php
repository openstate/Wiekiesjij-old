	...
	<body id="base">
		...
		<div id="wrap">
			...
			<div id="col_mid">
    		    	    ...
    		    	    <form action="vrk_stemadvies2.php?region=<?php echo $region; if (isset($_REQUEST['sw'])) { echo "&sw=".$_REQUEST['sw']; } ?>" id="stemhulpform" method="post">
<?php
$scr1 = "block";
$back1 = "0";
...
<!--						<div class="helpfooter">
							...
							<div onclick="nextPage(<?php echo $back1.",".($i + 1); ?>)" style="margin: 10px 0; width: 65px; float: right" class="button">
								<img class="button" alt="keuzerondje" src="layout/arr_right.png"/>
								<p class="button" style="padding: 0px 5px 0 21px; margin: 0; ">verder</p>
							</div>
							<div onclick="previousPage(<?php echo $back1.",".($i - 1); ?>)" style="margin: 10px 10px; width: 65px; float: right" class="button">
...
<!--						<h1 class="votehelptitle">Geslacht</h1> -->
        <div class="box">
...
<!--					<h1 class="votehelptitle">Gezinssituatie</h1>-->
	  ...
	  <div class="voortgang">[6 / 10]</div>
						...
						<div class="votequestion">
							...
							<div class="questionbox">
								<input type="checkbox" class="checkbox" id="burgerlijkestaat1" value="1" name="burgerlijkestaat[]"/><label for="burgerlijkestaat1">Alleenstaand</label><br/>
								<input type="checkbox" class="checkbox" id="burgerlijkestaat2" value="2" name="burgerlijkestaat[]"/><label for="burgerlijkestaat2">Relatie, niet samenwonend</label><br/>
								<input type="checkbox" class="checkbox" id="burgerlijkestaat3" value="3" name="burgerlijkestaat[]"/><label for="burgerlijkestaat3">Samenwonend</label><br/>
								<input type="checkbox" class="checkbox" id="burgerlijkestaat4" value="4" name="burgerlijkestaat[]"/><label for="burgerlijkestaat4">Getrouwd / Geregistreerd partnerschap</label><br/>
							</div>
						</div>
<!--						<div class="helpfooter">
							<?php $i++; echo "<h1>$i/$j</h1>"; ?>
...
<!--						<h1 class="votehelptitle">Levensovertuiging</h1> -->
	  ...
	  <div class="voortgang">[7 / 10]</div>
						...
						<div class="votequestion">
							...
							<div class="questionbox">
								<input type="checkbox" class="checkbox" id="geloof1" value="1" name="geloof[]"/><label for="geloof1">Aanhanger van een religie</label><br/>
								<input type="checkbox" class="checkbox" id="geloof2" value="2" name="geloof[]"/><label for="geloof2">Er is wel iets, maar ik weet niet wat</label><br/>
								<input type="checkbox" class="checkbox" id="geloof3" value="3" name="geloof[]"/><label for="geloof3">Agnost</label><br/>
								<input type="checkbox" class="checkbox" id="geloof4" value="4" name="geloof[]"/><label for="geloof4">Atheïst</label><br/>
							</div>

							<h2>Mijn kandidaat behoort tot de volgende geloofsgemeenschap:</h2>
							<div class="questionbox">
								<input type="checkbox" class="checkbox" id="gemeenschap1" value="1" name="gemeenschap[]"/><label for="gemeenschap1">Geen</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap2" value="2" name="gemeenschap[]"/><label for="gemeenschap2">Anders</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap3" value="3" name="gemeenschap[]"/><label for="gemeenschap3">Rooms-Katholiek kerk</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap4" value="4" name="gemeenschap[]"/><label for="gemeenschap4">Gereformeerde kerk</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap5" value="5" name="gemeenschap[]"/><label for="gemeenschap5">Nederlands Hervormde kerk</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap6" value="6" name="gemeenschap[]"/><label for="gemeenschap6">Overige Christelijke kerken</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap7" value="7" name="gemeenschap[]"/><label for="gemeenschap7">Islam</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap8" value="8" name="gemeenschap[]"/><label for="gemeenschap8">Jodendom</label><br/>
								<input type="checkbox" class="checkbox" id="gemeenschap9" value="9" name="gemeenschap[]"/><label for="gemeenschap9">Hindoeisme</label><br/>
							</div>
						</div>
