...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="javascript/vote.js?jsverbose" type="text/javascript"></script>
		<link href="layout/primary.css" rel="styleSheet" type="text/css"/>
		<title>Voorkeurstemmer</title>
	</head>

	<body id="base" onLoad="primaryInit()">
			...
			<div id="col_mid">
				...
				<?php
					...
					if($warn !== false) {
						...
						$sql = "SELECT ns_groslijst.id, voornaam, voorletters, tussenvoegsel, achternaam, nw_foto as foto, ns_fracties.naam AS fractienaam FROM ns_groslijst ";
						...
						while($r=$q->fetch()) {
							...
							if($r['foto'] != ''){
								$xhtml .= "<img alt=\"".$naam."\" style=\"border: 1px solid black\" src=\"foto/100/".$r['foto']."\"/>";
							}
							else {
								$xhtml .= "<img alt=\"".$naam."\" style=\"border: 1px solid black\" src=\"foto/100/_dummy.jpg\"/>";
							}
