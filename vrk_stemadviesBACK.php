 ...
 ************************************************************/
					...
					$sql2 = "INSERT INTO `ns_kiezerdata` (`naam` , `email` , `region`, `partijen`, `geslacht`, `leeftijd`, `expertise`, `sector`, `gezin`, `overtuig`, `geloof`, `opleiding`, `ervaring`, `eerstekamer`)
 						VALUES ('".base64_encode($_POST['eerstekamernaam'])."','".base64_encode($_POST['eerstekamermail'])."', $region, '$record', '".$gesl."', '$leeftd', '$exprt', '$sect', '$gezin', '$overt', '$gel', '$opl','$erva', '$eerstekamer')";
//					echo "<!-- $sql2 -->\n";
